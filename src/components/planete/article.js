...
import marsarticle from '../../assets/marsarticle.jpg'

const ArticlePlanete = () =>{
    return(
      <Container className="ArticlePlanete">
       <h1>Mars</h1>
       ...
       <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it
            ...
            <img src={marsarticle} height="500px" width="800px"></img>
            </p>
      </Container>
    )
}

export default ArticlePlanete